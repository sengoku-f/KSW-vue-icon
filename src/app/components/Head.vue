    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="relative z-10 flex items-center justify-between">
        <div class="flex items-center gap-4">
          <img class="h-7" src="../assets/klogo.svg" />
          <span class="text-xl font-semibold">KSW Design</span>
        </div>
        <div class="flex justify-center gap-8 lg:justify-start">
          <a
            class="-mx-1.5 -my-1 flex items-center gap-2 rounded-lg px-1.5 py-1 text-[0.8125rem] font-semibold leading-6 text-slate-900 transition hover:bg-slate-900/[0.03]"
          ...
          <a
            class="-mx-1.5 -my-1 flex items-center gap-2 rounded-lg px-1.5 py-1 text-[0.8125rem] font-semibold leading-6 text-slate-900 transition hover:bg-slate-900/[0.03]"
            href="https://www.npmjs.com/package/ksw-vue-icon"
            ><img class="size-6" src="../assets/NPM.svg" />NPM Packages</a
          >
          <a
            class="-mx-1.5 -my-1 flex items-center gap-2 rounded-lg px-1.5 py-1 text-[0.8125rem] font-semibold leading-6 text-slate-900 transition hover:bg-slate-900/[0.03]"
            href="/"
            ><img class="size-6" src="../assets/Mastergo.svg" />Mastergo File</a
          >
        </div>
      </div>
      <div class="flex justify-center text-center lg:pb-7 lg:pt-5 lg:text-left">
        <div class="flex max-w-[37rem] flex-col py-16 lg:pb-11 lg:pt-12">
          ...
          <div class="mt-10 flex justify-center gap-8 lg:justify-start">
            <a
              class="-mx-1.5 -my-1 flex items-center gap-3 rounded-full bg-blue-600 px-4 py-2 text-base font-medium leading-6 text-white transition hover:bg-blue-800"
              href="https://ksw.design.donxj.com/components/General/icon"
            >
              Get Started</a
            >
            <button
              class="relative -mx-1.5 -my-1 flex items-center gap-3 overflow-hidden rounded-full border border-slate-300 px-4 py-2 text-base font-medium leading-6 text-slate-900 transition hover:border-blue-600 hover:text-blue-600"
              @click="copyCode()"
            >
              {{ npmInstallCode }}
              <IconCopy />
              <div
                ...
                class="absolute left-0 top-0 flex h-full w-full items-center justify-center gap-2 bg-white/[0.36] backdrop-blur-2xl transition duration-500"
          ...
          <div class="relative aspect-square w-72 flex-none">
            <svg viewBox="0 0 288 288" fill="none" class="absolute inset-0 h-full w-full overflow-visible">
              <g>
                ...
                >
                  <path
                    ...
                    style="--darkreader-inline-fill: #4b5e7b; --darkreader-inline-stroke: #ffffff"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                  ...
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="m-200.75 95.231h689.5v13.5h-689.5z"
                    data-darkreader-inline-fill=""
                    data-darkreader-inline-stroke=""
                    style="--darkreader-inline-fill: #4b5e7b; --darkreader-inline-stroke: #ffffff"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="m-200.75 179.27h689.5v13.5h-689.5z"
                    data-darkreader-inline-fill=""
                    data-darkreader-inline-stroke=""
                    style="--darkreader-inline-fill: #4b5e7b; --darkreader-inline-stroke: #ffffff"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="m192.769-200.75v689.5h-13.5v-689.5z"
                    data-darkreader-inline-fill=""
                    data-darkreader-inline-stroke=""
                    style="--darkreader-inline-fill: #4b5e7b; --darkreader-inline-stroke: #ffffff"
                  ></path>
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="m108.731-200.75v689.5h-13.5v-689.5z"
                    data-darkreader-inline-fill=""
                    data-darkreader-inline-stroke=""
                    style="--darkreader-inline-fill: #4b5e7b; --darkreader-inline-stroke: #ffffff"
                  ></path>
              ...
              <defs>
                ...
                >
                  <stop stop-color="#D9D9D9" data-darkreader-inline-stopcolor="" style="--darkreader-inline-stopcolor: #303639"></stop>
                  <stop
                    offset=".81"
                    stop-color="#D9D9D9"
                    stop-opacity="0"
                    data-darkreader-inline-stopcolor=""
                    style="--darkreader-inline-stopcolor: #303639"
                  ></stop>
                </radialGradient>
              </defs>
            </svg>
            ...
            <svg viewBox="0 0 288 288" fill="none" aria-hidden="true" class="absolute inset-0 h-full w-full overflow-visible">
              <path
                ...
                data-darkreader-inline-fill=""
                data-darkreader-inline-stroke=""
                style="--darkreader-inline-fill: #20009d; --darkreader-inline-stroke: #bd78ff"
              ></path>
              ...
              <g stroke="#000" stroke-opacity=".2" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" stroke-dasharray="2 4">
              ...
              <defs>
                <linearGradient id="e" x1="375.75" y1="296.754" x2="-69.25" y2="296.754" gradientUnits="userSpaceOnUse">
                  <stop
                    ...
                    stop-opacity="0"
                    data-darkreader-inline-stopcolor=""
                    style="--darkreader-inline-stopcolor: #000820"
                  ></stop>
                  <stop
                    offset=".258"
                    stop-color="#0F172A"
                    ...
                    style="--darkreader-inline-stopcolor: #000820"
                  ></stop>
                  <stop offset=".521" stop-color="#0F172A" data-darkreader-inline-stopcolor="" style="--darkreader-inline-stopcolor: #000820"></stop>
                  <stop
                    offset=".784"
                    stop-color="#0F172A"
                    stop-opacity=".6"
